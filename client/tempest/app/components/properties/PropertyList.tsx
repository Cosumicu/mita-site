    ...
    return (
      <div className="relative space-y-2 sm:space-y-4">
        ...
        <div className="-mx-4 sm:mx-0">
          <div
            ref={scrollRef}
            className="flex gap-3 overflow-x-auto scroll-smooth pl-4 sm:pl-0 pr-4 [scrollbar-width:none] [-ms-overflow-style:none] [&::-webkit-scrollbar]:hidden"
          >
            {Array.from({ length: 8 }).map((_, i) => (
              <div key={i} className="shrink-0" data-card>
                <Card
